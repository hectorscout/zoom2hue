...
const setLightOnOff = (state, lightId = 10) => {
    axios
      .put(`${HUE_BASE_URL}/bridge/${HUE_USERNAME}/lights/${lightId}/state`, {on: state === 'on', bri: 254, hue: 0, sat: 254}, {headers: authHeaders})
...
app.get('/light/:lightid/:state', (req, res) => {
    axios
      .put(`${HUE_BASE_URL}/bridge/${HUE_USERNAME}/lights/${req.params.lightid}/state`, {on: req.params.state === 'on'}, {headers: authHeaders})
      .then(lightRes => {
